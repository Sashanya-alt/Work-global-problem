...
// MFCApplication5.cpp: определяет поведение классов для приложения.
//
...
// Единственный объект CMFCApplication5App

CMFCApplication5App theApp;


// Инициализация CMFCApplication5App
